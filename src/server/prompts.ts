      ...
      createMessage(
        createStructuredPrompt({
          ...
          constraints: [
            ...
            '    - Break intervals: Schedule 5-10 minute breaks between time blocks (these breaks are NOT calendar events - just plan the timing between blocks). Do NOT create calendar events for breaks',
