      ...
      createMessage(
        createStructuredPrompt({
          ...
          process: [
            ...
            'Estimate effort for each actionable reminder: classify as Quick Win (5-15 minutes) or Standard Task (30-60 minutes). Flag anything above 60 minutes for task splitting suggestions.',
            ...
            'When adjusting or creating multiple reminders due today with explicit due times, schedule matching calendar.events time blocks aligned to those due windows to protect focus capacity.',
          ...
          qualityBar: [
            ...
            'Standard tasks are scoped to 30-60 minutes and grouped for potential deep work batching.',
